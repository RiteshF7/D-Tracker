        ...
        <div className="space-y-6 pb-24">
            ...
            <div className="glass-card p-4 rounded-2xl space-y-3">
                ...
                <div className="flex justify-center gap-6">
                    {[
                        { id: "happy", icon: Smile, color: "text-blue-400", bg: "bg-blue-400/20" },
                ...
                <AnimatePresence>
                    {showSaved && (
                        <motion.div
                            ...
                            exit={{ opacity: 0, y: 10 }}
                            className="absolute bottom-20 right-4 bg-blue-500/20 text-blue-400 border border-blue-500/30 px-4 py-2 rounded-xl text-sm font-bold backdrop-blur-md shadow-xl"
                        >
                            Entry Saved!
                        </motion.div>
                    )}
